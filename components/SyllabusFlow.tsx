    ...
    <div className="max-w-4xl mx-auto h-full flex flex-col animate-fade-in p-6 relative">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <div className="text-[10px] text-[var(--ui-text-muted)] mt-1 font-mono uppercase">
             ACTIVE ENGINE: <span className="text-[var(--ui-primary)] font-bold">{config.provider.toUpperCase()}</span> ({config.model})
          </div>
        </div>
        
        {/* View Switcher - THEMED */}
        <div className="flex bg-[var(--ui-surface)] p-1 rounded-lg border border-[var(--ui-border)]">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex gap-1">
                            <button onClick={handleSaveToLibrary} className="p-2 bg-[var(--ui-bg)] hover:bg-[var(--ui-border)] text-[var(--ui-text-muted)] hover:text-[var(--ui-text-main)] rounded-lg"><Save size={16} /></button>
                            <button onClick={handleClearActive} className="p-2 bg-[var(--ui-bg)] hover:bg-red-900/30 text-[var(--ui-text-muted)] hover:text-red-400 rounded-lg"><Trash2 size={16} /></button>
                        </div>
                    </div>
                </div>
